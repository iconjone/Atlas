var routes = [
  ...
  {
    path: '/bus-select/',
    componentUrl: './pages/bus-select.html',
  },
  {
    path: '/bus-times/:route/',
    componentUrl: './pages/bus-times.html',
  },
  {
    path: '/bus-timeson/:route/',
    componentUrl: './pages/bus-timeson.html',
  },
  {
    path: '/stops/:stopName/',
    componentUrl: './pages/stops.html',
  },
  {
    path: '/stopson/:stopName/',
    componentUrl: './pages/stopson.html',
  },
